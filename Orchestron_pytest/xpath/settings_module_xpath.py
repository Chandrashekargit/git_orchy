...
warning_msg_if_we_update_domain_name_while_user_exist = "//p[contains(text(),'* User(s) with this domain configuration already exists, to edit domain name please delete the users.']"
