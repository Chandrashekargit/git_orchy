...
request_xpath = "//div[@class='col-12']/div[4]//label[@class='custom-file-label']"
response_xpath = "//div[@class='col-12']/div[5]//label[@class='custom-file-label']"
...
evd_success_msg = "//p[text()='Evidence successfully reopened!']"
